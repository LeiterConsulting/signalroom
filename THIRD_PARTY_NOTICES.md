...
Architecture and product-flow inspiration was drawn from `LeiterConsulting/splunk-discovery-tool`, copyright © 2025 Leiter Consulting, licensed under the MIT License. This repository is a new implementation and does not vendor the upstream source.

Upstream: <https://github.com/LeiterConsulting/splunk-discovery-tool>
