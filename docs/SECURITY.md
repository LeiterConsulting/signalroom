...
- Detection-as-code projects require completed preserved validation evidence. Edits create immutable versions, review is bound to the exact content SHA-256, approved projects are retained, and exports contain no raw result rows.
