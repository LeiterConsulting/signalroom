...
- SignalRoom does not yet provide Teams, email, ticketing, or SOAR adapters, external-record reconciliation, or destination-native update/delete workflows.
